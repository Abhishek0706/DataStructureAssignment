#program for implementing A* algorithm
import sys
import pickle
...
print('''
Enter distance criterian For The A* Algorithm:
...
source = input("Enter the source as 0,0 : ")
source = source.split(',')
...
destination = input("Enter the destination as 7,7: ")
...
for p in arr:
	maze[p.y][p.x] = 0.5
colors = [(0,"black"),(0.25,"yellowgreen"),(0.5,"cyan"),(0.75,"orange"),(1,"white")]
